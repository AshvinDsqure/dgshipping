...
/**
 * Service interface class for the Item object. The implementation of this class
 * is responsible for all business logic calls for the Item object and is
 * autowired by spring
 *
 * @author kevinvandevelde at atmire.com
 */
public interface EventTrackService extends DSpaceObjectService<Event>, DSpaceObjectLegacySupportService<Event> {
    ...
    public List<Event> getDataByFilter(Context context, String query, int start) throws Exception;
