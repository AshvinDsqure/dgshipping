...
public class DSpaceApiExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected void SessionInvalidatedException(HttpServletRequest request, HttpServletResponse response,
                                            Exception ex) throws IOException {
        sendErrorResponse(request, response, ex, "Your session has expired because your account was logged in from another device.", HttpServletResponse.SC_UNAUTHORIZED);
    }
