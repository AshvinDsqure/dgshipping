...
import org.dspace.app.rest.repository.WorkflowProcessRestRepository;
 ...
 */
@RestController
@RequestMapping("/api/core/workflowprocesses" + REGEX_REQUESTMAPPING_IDENTIFIER_AS_UUID)
public class WorkflowProcessRestController {
    ...
    @Autowired
    private WorkflowProcessRestRepository workflowProcessRestRepository;
    ...
    public TemplateItemResource forward(HttpServletRequest request, @PathVariable UUID uuid) {

        /*Context context = ContextUtil.obtainContext(request);
        TemplateItemRest templateItem = workflowProcessRestRepository.
